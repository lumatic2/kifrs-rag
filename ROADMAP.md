...
> 마지막 업데이트: 2026-07-05 (RPG5 완료, OEH1 시작)
...
<!-- harness:milestone id="OEH1" status="active" priority="P0" -->
### OEH1 — Operator Command Inventory
- DoD: demo, readiness, quality, parser, source, workflow, retriever, diagnostics commands are indexed by operator goal.
- Evidence: `docs/reports/2026-07-05-oeh1-operator-command-inventory.md`; plan `docs/plans/2026-07-05-operator-experience-hardening.md`
- Gap: scripts/reports are numerous and useful, but operator discovery is still spread across ROADMAP history.
- Status: [ ]
...
- OEH1 operator command inventory — active
