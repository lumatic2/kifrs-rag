...
| **Drift watch (현재)** | KASB 제·개정 감지 + 단위 갱신 경로 | 진행 중 |

## Current Horizon — kasb-drift-watch

<!-- harness:goal id="kasb-drift-watch" status="active" -->
