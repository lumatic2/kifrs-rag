...
> 마지막 업데이트: 2026-07-05 (product-trust-and-quality-evidence 완료, real-local-parser-prototype 시작)
...
<!-- harness:milestone id="RLP1" status="active" priority="P0" -->
### RLP1 — Parser Prototype Asset Inventory
- DoD: 기존 parser contract, adapter scaffold, deletion gate, dry-run fixture를 inventory하고 RLP2~RLP5 gap을 확정한다.
- Evidence: `docs/reports/2026-07-05-rlp1-parser-prototype-asset-inventory.md`; plan `docs/plans/2026-07-05-real-local-parser-prototype.md`
- Gap: private parser runtime contract는 있지만 실제 prototype 구현 전 재사용할 자산과 빈틈이 정리되지 않았다.
- Status: [ ]
...
- RLP1 parser prototype asset inventory — active
