...
> 마지막 업데이트: 2026-07-05 (RPG1 완료, RPG2 시작)
...
<!-- harness:milestone id="RPG2" status="active" priority="P0" -->
### RPG2 — Regression And Latency Gate
- DoD: promotion cannot pass unless recall/citation regressions and basic runtime cost limits are explicitly checked.
- Evidence: `docs/reports/2026-07-05-rpg2-regression-latency-gate.md`; plan `docs/plans/2026-07-05-runtime-retriever-promotion-gate.md`
- Gap: RPG1 inventoried evidence, but no regression/latency gate combines recall, citation, and runtime cost checks.
- Status: [ ]
...
- RPG2 regression and latency gate — active
