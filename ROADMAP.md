...
> 마지막 업데이트: 2026-07-05 (RPG4 완료, RPG5 시작)
...
<!-- harness:milestone id="RPG5" status="active" priority="P0" -->
### RPG5 — Promotion Gate Close Report
- DoD: horizon closes with an explicit `promote`, `defer`, or `block` result and rollback evidence.
- Evidence: `docs/reports/2026-07-05-runtime-retriever-promotion-gate-close-report.md`; plan `docs/plans/2026-07-05-runtime-retriever-promotion-gate.md`
- Gap: RPG1~RPG4 are individual evidence pieces; horizon close still needs one explicit promotion decision.
- Status: [ ]
...
- RPG5 promotion gate close report — active
