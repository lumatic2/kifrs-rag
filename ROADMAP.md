...
**Phase 2 검색 인프라 완성** — Round 2 hybrid 80% recall 달성. 다음은 답변 포맷 + 정확도 정밀 검증.
...
8. [ ] **🟡 [2순위] /accounting 시험 풀이 모드 분기** — 다단 sub-question + 계산 표 + 분개 코드블록
9. [ ] [3순위] 학원 모범답안 입수 + Q01~Q05 산식 정밀 검증
10. [ ] **A축 측정 시작** — 본인이 회계 학습·실무에서 주 3회 자발 사용 (4주 누적)
