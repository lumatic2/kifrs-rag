...
> 마지막 업데이트: 2026-07-05 (RPG3 완료, RPG4 시작)
...
<!-- harness:milestone id="RPG4" status="active" priority="P0" -->
### RPG4 — Operator Promotion Command
- DoD: operator can see promote/defer status and required evidence without editing runtime code by hand.
- Evidence: `docs/reports/2026-07-05-rpg4-operator-promotion-command.md`; plan `docs/plans/2026-07-05-runtime-retriever-promotion-gate.md`
- Gap: RPG3 defines rollback policy, but no operator-facing dry-run command summarizes the promotion status yet.
- Status: [ ]
...
- RPG4 operator promotion command — active
