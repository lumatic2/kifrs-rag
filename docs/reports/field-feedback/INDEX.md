...
8. `docs/reports/2026-07-05-espdn1-external-source-connector-post-close-demo-packet-note.md`
   - KASB/FSS 외부자료 connector가 metadata-only 보조 근거임을 먼저 설명하는 reviewer-facing note.
