...
- actual accountant session evidence is still external/user-owned; invite, response handling, scheduled-session, and RS3 capture-readiness gates are ready but the reviewer invite has not been sent
