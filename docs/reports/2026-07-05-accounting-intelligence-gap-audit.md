...
| default_retriever_guard | `docs/reports/2026-07-05-default-retriever-guard.md` | present |
| accounting_intelligence_progress_map | `docs/reports/2026-07-05-accounting-intelligence-progress-map.md` | present |
...
| real_accountant_filled_receipt_guide | `docs/reports/real-accountant-session/2026-07-05-filled-receipt-guide.md` | present |
| real_accountant_invite_receipt_apply | `docs/reports/real-accountant-session/2026-07-05-invite-receipt-apply.md` | present |
| real_accountant_post_send_rehearsal_gate | `docs/reports/real-accountant-session/2026-07-05-post-send-rehearsal-gate.md` | present |
