...
| DRQ2 | demo run quality checklist | active |
...
| run_demo_rehearsal_quality_loop | active_horizon | none | `python scripts\demo_run_quality_checklist.py --format text --write` |
...
- decision: `DRQ2_demo_run_quality_checklist`
