...
def test_gap_audit_covers_current_expansion_evidence() -> None:
    ...
    assert "external source connector live-metadata probe scaffold is present" in joined_gaps
    assert "live-metadata close gate is not implemented" in joined_gaps
