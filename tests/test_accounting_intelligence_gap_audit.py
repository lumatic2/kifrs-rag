...
def test_gap_audit_covers_current_expansion_evidence() -> None:
    ...
    assert "invite, response handling, after-send action matrix, scheduled-session, RS3 notes-quality/capture-readiness, operator execution brief, pre-send final gate, and close-state matrix are ready" in joined_gaps
