...
REQUIRED_REPORTS = {
    ...
    / "docs"
    / "reports"
    / "2026-07-05-accounting-intelligence-decision-queue.md",
    "accounting_intelligence_next_action": ROOT
    / "docs"
    / "reports"
    / "2026-07-05-accounting-intelligence-next-action.md",
    "accounting_intelligence_next_action_sequence_gate": ROOT
    / "docs"
    / "reports"
    / "2026-07-05-accounting-intelligence-next-action-sequence-gate.md",
    "real_accountant_invite_dispatch_gate": ROOT
    / "docs"
    / "reports"
    / "real-accountant-session"
    / "2026-07-05-invite-dispatch-gate.md",
    "real_accountant_reviewer_invite_action_packet": ROOT
    / "docs"
    / "reports"
    / "real-accountant-session"
    / "2026-07-05-reviewer-invite-action-packet.md",
    "real_accountant_invite_send_receipt": ROOT
    / "docs"
    / "reports"
    / "real-accountant-session"
    / "2026-07-05-invite-send-receipt.md",
    "real_accountant_post_send_rehearsal_gate": ROOT
    / "docs"
    / "reports"
    / "real-accountant-session"
    / "2026-07-05-post-send-rehearsal-gate.md",
    "real_accountant_readiness_index": ROOT
    / "docs"
    / "reports"
    / "real-accountant-session"
    / "2026-07-05-readiness-index.md",
    "real_accountant_external_action_boundary_gate": ROOT
    / "docs"
    / "reports"
    / "real-accountant-session"
    ...
    "real_accountant_outreach_transition_verify": ROOT
    / "docs"
    / "reports"
    / "real-accountant-session"
    / "2026-07-05-outreach-transition-verify.md",
    "real_accountant_notes_quality_gate": ROOT
    / "docs"
    / "reports"
    / "real-accountant-session"
    / "2026-07-05-notes-quality-gate.md",
    "real_accountant_post_session_final_gate": ROOT
    / "docs"
    / "reports"
    / "real-accountant-session"
    / "2026-07-05-post-session-final-gate.md",
    "real_accountant_close_state_matrix": ROOT
    / "docs"
    / "reports"
    / "real-accountant-session"
    / "2026-07-05-close-state-matrix.md",
...
def build_gap_audit() -> GapAudit:
    ...
    remaining_gaps = [
        "actual accountant session evidence is still external/user-owned; decision queue, next-action summary, next-action sequence gate, reviewer invite action packet, invite send receipt, post-send rehearsal, readiness index, external-action boundary, invite, response handling, after-send action matrix, outreach transition verifier, scheduled-session, RS3 notes-quality/capture-readiness/post-session final gate, operator execution brief, pre-send final gate, and close-state matrix are ready but the reviewer invite has not been sent",
