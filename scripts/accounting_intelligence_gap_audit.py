...
def build_gap_audit() -> GapAudit:
    ...
    remaining_gaps = [
        "actual accountant session evidence is still external/user-owned; invite, response handling, and scheduled-session gates are ready but the reviewer invite has not been sent",
